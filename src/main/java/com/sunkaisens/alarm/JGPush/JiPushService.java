package com.sunkaisens.alarm.JGPush;
...
public class JiPushService {
	 ...
	 * @return 0推送失败，1推送成功
	 */
	public int sendToAliasList(List<String> aliasList, String notification_title, String msg_title, String msg_content,
			String extrasparam) {
		int result = 0;
		try {
			PushPayload pushPayload = buildPushObject_all_aliasList_alertWithTitle(aliasList, notification_title,
					msg_title, msg_content, extrasparam);
			LOGGER.info("推送给设备标识参数的用户" + pushPayload);
			IosAlert iosAlert = IosAlert.newBuilder().setTitleAndBody("告警信息","告警信息","PBNO<<<<<<<<<<<<").build();

			PushResult pushResult = jPushClient.sendIosNotificationWithAlias(iosAlert,new HashMap<>());
	 ...
	 * @return 0推送失败，1推送成功
	 */
	public int sendToTagList(List<String> tagsList, String notification_title, String msg_title, String msg_content,
			String extrasparam) {
		int result = 0;
		try {
			PushPayload pushPayload = buildPushObject_all_tagList_alertWithTitle(tagsList, notification_title,
					msg_title, msg_content, extrasparam);
	 ...
	 * @return
	 */
	private static PushPayload buildPushObject_all_aliasList_alertWithTitle(List<String> aliasList,
